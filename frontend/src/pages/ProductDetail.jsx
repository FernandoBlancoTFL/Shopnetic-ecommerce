...
export function ProductDetail () {
  ...
  return (
    <>
      <Seo
        title={`Comprar ${product.title} | Shopnetic`}
        description={product.description}
        keywords={`comprar, ${product.title}, ${product.brand}, ${product.category}`}
        image={product.thumbnail || product.images[0]}
        url={`https://shopneticfb.netlify.app/product/${product.id}`}
      />
